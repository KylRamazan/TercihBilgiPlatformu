      ...
      form,
      {
        fields: {
          Email: {
            validators: {
              notEmpty: {
                message: 'Email alaný zorunludur!'
              },
              emailAddress: {
          ...
          Password2: {
            validators: {
              notEmpty: {
                message: 'Þifre tekrar alaný zorunludur!'
              }
            }
          }
        },
      ...
      form,
      {
        fields: {
          AdSoyad: {
            validators: {
              notEmpty: {
                message: 'Ad Soyad alaný zorunludur!'
              }
            }
          },
          Telefon: {
            validators: {
              notEmpty: {
                message: 'Telefon alaný zorunludur!'
              }
            }
          },
          KullaniciAdi: {
            validators: {
              notEmpty: {
                message: 'Kullanýcý Adý alaný zorunludur!'
              }
            }
          },
          DogumTarihi: {
            validators: {
              notEmpty: {
                message: 'Doðum Tarihi alaný zorunludur!'
              }
            }
          },
          OkulAdi: {
            validators: {
              notEmpty: {
                message: 'Okul Adý alaný zorunludur!'
              }
            }
          },
          BolumAdi: {
            validators: {
              notEmpty: {
                message: 'Bölüm Adý alaný zorunludur!'
              }
            }
          }
        },
